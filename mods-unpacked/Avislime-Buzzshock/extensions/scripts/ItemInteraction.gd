...
func InteractWith(itemName : String):
	...
	match (itemName):
		"handcuffs":
			Buzzshock.BuzzshockEvent("Handcuffs")
		...
		"magnifying glass":
			Buzzshock.BuzzshockEvent("Magnifying Glass")
			...
			EnablePermissions()
		"cigarettes":
			Buzzshock.BuzzshockEvent("Cigarettes")
			...
			EnablePermissions()
		"handsaw":
			Buzzshock.BuzzshockEvent("Handsaw")
		...
		"expired medicine":
			...
			#EnablePermissions()
		"inverter":
			Buzzshock.BuzzshockEvent("Inverter")
			...
			EnablePermissions()
		"burner phone":
			Buzzshock.BuzzshockEvent("Burner Phone")
			...
			EnablePermissions()
		"adrenaline":
			Buzzshock.BuzzshockEvent("Adrenaline")
